...
class RescaleTransform:
    ...
    def __call__(self, image):
        ...
        # Apply min-max scaling to rescale from in_range to out_range
...
def compute_image_mean_and_std(images):
    ...
    assert mean.shape == (images.shape[3],)
    assert std.shape == (images.shape[3],)
...
class NormalizeTransform:
    ...
    def __call__(self, images):
        ...
        normalized_images = (normalized_images - self.mean) / self.std
